const tech = {
    ...
    },
    {
        ...
        descriptionFunction() {
            return `after you collect ${powerUps.orb.research(2 + Math.floor(0.1666 * b.totalBots()))}use them to build a<br>random <strong class='color-bot'>bot</strong>`
        },
    ...
    },
    {
        name: "paradigm shift",
        descriptionFunction() {
            return `when <strong>paused</strong> clicking a <strong class='color-m'>tech</strong> <span class='color-remove'>ejects</span> it<br><strong>+5%</strong> <strong class='color-junk'>JUNK</strong><strong class='color-m'>tech</strong> chance each time`
        },
        maxCount: 1,
        count: 0,
        frequency: 1,
    ...
    },
    {
        ...
        description: `<strong>+4</strong> diverging <strong class='color-laser'>laser</strong> <strong class='color-g'>gun</strong> beam`,
        isGunTech: true,
        maxCount: 9,
        count: 0,
        frequency: 1,
    ...
    {
        name: "discount",
        description: "get 100 random <strong class='color-junk'>JUNK</strong><strong class='color-m'>tech</strong> for the price of 1!",
        maxCount: 1,
        count: 0,
        frequency: 0,
        isJunk: true,
